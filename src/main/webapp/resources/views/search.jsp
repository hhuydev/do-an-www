...
import="com.webstore.app.model.Cart" %> <%@ taglib uri =
"http://java.sun.com/jsp/jstl/core" prefix = "c" %> <%@ taglib prefix="fmt"
...
<html>
  ...
  <body>
    <% Cart cart = (Cart) session.getAttribute("cart"); if (cart == null) { cart
    = new Cart(); session.setAttribute("cart", cart); } %>
      ...
      <div class="container">
        <div class="col-md-4 products-left">
          <div class="filter-price animated wow slideInUp" data-wow-delay=".5s">
            ...
            <script
              type="text/javascript"
              src="/resources/js/jquery-ui.min.js"
            ></script>
            <!---->
          </div>
        ...
        <div class="col-md-8 products-right">
          <div class="products-right-grid">
            <div
              class="products-right-grids animated wow slideInRight"
              data-wow-delay=".5s"
            >
            ...
            >
              <img
                src="/resources/images/slider3.jpg"
                alt=" "
              ...
              <div class="new-collections-grid-sub-grids">
                ...
                <c:forEach items="${products}" var="p">
                  <div class="new-collections-grid1-sub" style="width: 30%">
                    ...
                    >
                      <div
                        class="new-collections-grid1-image"
                        style="width: 190.99px"
                      >
                        <a
                          href="/shop/single/${p.productID}"
                          class="product-image"
                        >
                          <img
                            style="width: 190.99px"
                      ...
                      <h4 style="font-size: 16px">
                        <a href="/shop/single/${p.productID}"
                          >${p.productName}</a
                        >
                      </h4>
                      ...
                      <div
                        class="
                          ...
                          products-right-grid1-add-cart
                        "
                      >
                        <p>
                          <i></i>
                          <span class="item_price" style="white-space: nowrap"
                            ><fmt:formatNumber
                            ...
                            VNĐ</span
                          >
                          <a class="item_add" href="/cart/plus/${p.productID}"
                            >Thêm Vào Giỏ Hàng
                          </a>
                        </p>
                      </div>
