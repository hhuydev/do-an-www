	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				<form class="animated wow slideInUp form-regis" data-wow-delay=".5s"
					action="/user/login" method="POST">
					<input type="email" placeholder="Email" required name="email"
						id="email"> <input type="password" placeholder="Mật khẩu"
						class="pwd" name="password" required> <input
						type="password" placeholder="Nhập lại mật khẩu" class="repwd"
					...
					<button type="button" class="info" onclick="validatePhone()">Đăng
						Ký</button>
