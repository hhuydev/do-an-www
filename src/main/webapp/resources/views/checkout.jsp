		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1>
						<a href="/shop/homepage">Nội thất<span>Shop anywhere</span></a>
					</h1>
				</div>
		...
		<div class="container">
			<div class="checkout-right animated wow slideInUp"
				...
				<table class="timetable_sub">
					...
					<tr class="rem1">
						...
						<td class="invert-image" style="width: 25%"><a href="single">
						...
						<td class="invert" style="width: 10%"><a
							...
							onclick="removeItem(<%=list.getValue().getProduct().getProductID()%>)">
								<img src="/resources/images/delete-xxl.png" alt=""
			...
			<div class="checkout-left">
				<div class="checkout-left-basket animated wow slideInLeft"
					...
					<ul>
						...
						<li>Tổng Tiền: <span> <fmt:formatNumber
									value="${totalPrices}" type="currency" currencySymbol="" />
								VNĐ
						</span></li>
					</ul>
				</div>
				<div class="checkout-right-basket animated wow slideInRight"
					data-wow-delay=".5s">
					<a href="/shop/history"><span
						class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Lịch
						sử mua hàng</a> <a href="/shop/homepage"><span
