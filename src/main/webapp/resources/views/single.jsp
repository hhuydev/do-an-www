...
<body>
	<%-- <div class="container">
			...
			<div class="header-grid-left animated wow slideInLeft"
				...
				<ul>
					<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
						href="mailto:info@example.com">example@gmail.com</a></li>
		...
		<div class="logo-nav">
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<c:forEach items="${cates}" var="c">
													<li><a href="/shop/single/product/${c.categoryID}">${c.categoryName}</a>
													</li>
												</c:forEach>
											</ul>
										</div>
			...
			<div class="header-right" style="margin-top: 80px">
					...
					<a href="/shop/checkout">
						<h3>
							<div class="total">
								...
								Sản Phẩm) <img src="/resources/images/bag.png" alt="" />
						</h3>
					</a>
					<p>
	...
	<div class="container">
		...
		<div class="logo-nav">
			...
			<div class="header-right" style="margin-top: 90px">
				<div class="cart box_1">
					<a href="/shop/checkout">
						<h3>
							<div class="total">
	...
	<div class="container" style="padding-top: 20px;">
		<div class="col-md-4 products-left">
			...
			<div class="categories animated wow slideInUp" data-wow-delay=".5s">
				...
				<ul class="cate">
					<c:forEach items="${categories}" var="c">
						<li><a href="product/${c.categoryID}">${c.categoryName} </a></li>
					</c:forEach>
		...
		<div class="col-md-8 single-right">
			...
			<div
				class="col-md-7 single-right-left simpleCart_shelfItem animated "
				data-wow-delay=".5s">
