		...
		<div class="container" style="padding: 10px">
			...
			<div class="login-form-grids animated wow slideInUp"
				...
				<form action="/user/login" method="POST">
					...
					<!-- <a href="/shop/homepage" class="btn btn-info"
						role="button">Đăng Nhập</a> -->
				</form>
			</div>
			<h4 class="animated wow slideInUp" data-wow-delay=".5s">Người
				Mới</h4>
			<p class="animated wow slideInUp" data-wow-delay=".5s">
				<a href="register">Đăng Ký</a> hoặc đi đến <a href="/shop/homepage">Trang
					Chủ <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>
				</a>
			</p>
		</div>
